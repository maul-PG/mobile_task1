...
| No. | Nama Lengkap | NIM |
|:---:|:---|:---:|
| 1 | Rafi'i Maulana | 124240138 |
| 2 | Aslam Arganda | 124240179 |
| 3 | Ahmad Santosa | 124240200 |
...
### Prasyarat
Pastikan **Dart SDK** sudah terpasang di sistem operasi.

### Langkah Eksekusi
1. Lakukan *clone* repositori:
   ```bash
   git clone [https://github.com/maul-PG/mobile_task1.git](https://github.com/maul-PG/mobile_task1.git)
   cd mobile_task1